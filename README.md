...
| 🔍 **Discovery State Machine** | Tracks conversation flow through discovery phases. Ralph asks **dynamic, contextual questions** based on actual codebase analysis to clarify vague tasks. **Now powered by Claude** to extract precise requirements from your answers! Better requirements = better code. Use 'start building' to skip the chit-chat or 'more questions' to keep digging! |
